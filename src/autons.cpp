...
void default_constants() {
  ...
  chassis.set_pid_constants(&chassis.headingPID, 13, 0, 35, 0);
  chassis.set_pid_constants(&chassis.forward_drivePID, 1.1, 0, 8.5, 0);
  chassis.set_pid_constants(&chassis.backward_drivePID, 1.1, 0, 8.25, 0);
  chassis.set_pid_constants(&chassis.turnPID, 7, 0.003, 45, 15);
...
void elims_close_rush() {
  ...
  chassis.wait_drive();
  wings.setFrontWings(true);
  chassis.set_drive_pid(29, DRIVE_SPEED+10);
  chassis.wait_drive();
  intake.spin(false);
  pros::delay(150);
  intake.stop();
...
void elims_far_rush() {
  ...
  chassis.set_drive_pid(-7, DRIVE_SPEED);
  chassis.wait_drive();
  chassis.set_swing_pid(LEFT_SWING, 263, SWING_SPEED);
  chassis.wait_drive();
  intake.spin(true);
  ...
  wings.setBackWings(false);
  pros::delay(150);
  chassis.set_swing_pid(LEFT_SWING, 200, SWING_SPEED);
  chassis.wait_drive();
  chassis.mode = ez::DISABLE;
  chassis.set_tank(-127, -127);
  pros::delay(500);
