...
void elims_far_rush_safe() {
  ...
  pros::delay(450);
  chassis.set_tank(0, 0);
  chassis.set_drive_pid(-12, DRIVE_SPEED + 10);
  chassis.wait_drive();
...
void skills() {
  ...
  chassis.wait_drive();
  wings.setFrontWings(true);
  chassis.set_swing_pid(LEFT_SWING, 405, SWING_SPEED - 20);
  chassis.wait_drive();
  chassis.set_drive_pid(20, DRIVE_SPEED - 10);
  chassis.wait_drive();
  chassis.set_turn_pid(450, TURN_SPEED);
  chassis.wait_drive();
  intake.spin(false);
  ...
  chassis.set_drive_pid(-13, DRIVE_SPEED);
  chassis.wait_drive();
  chassis.set_turn_pid(470, TURN_SPEED);
  chassis.wait_drive();
  intake.spin(false);
  wings.setFrontWings(true);
  chassis.set_drive_pid(24, DRIVE_SPEED + 10);
  chassis.wait_drive();
  chassis.mode = ez::DISABLE;
  chassis.set_tank(127, 127);
  pros::delay(500);
